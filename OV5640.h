/*
 ...
 File Description:
 This file defines the configuration registers for the OV5640 camera.

*/

#ifndef _INCLUDED_SENSOR5640_H_
#define _INCLUDED_SENSOR5640_H_
...
static regval_list_t sensor_default_regs[] = {
...
// 24MHz input clock
    ...
    { 0x3016, 0x00 }, // STROBE pin is an input
    //{0x3B00, 0xC3},	// STROBE CTRL: Strobe request ON/OFF, Strobe pulse reverse
    { 0x3017, 0xff }, // FREX, Vsync, HREF, PCLK, D[9:6] output enable
    { 0x302C, 0x22 }, // Output drive capability
    { 0x3018, 0xff }, // D[5:0], GPIO[1:0] output enable
    { 0x301d, 0x80 }, // FREX output low, VSYNC, HREV, PCLK, D[9:6] output datapath
    { 0x3034, 0x1a }, // PLL
    ...
    { 0x4745, 0x02 }, // DVP order: D[1:0], D[9:2]
    { 0x3630, 0x36 },
    { 0x3631, 0x0e },
    { 0x3632, 0xe2 },
    { 0x3633, 0x12 },
...
#endif
#ifdef OV5640_1B
    // MZ Nuova fotocamera (come tps di Mattia Bortolato)
    {0x5180, 0xff},
    {0x5181, 0xf2},
    {0x5182, 0x00},
    {0x5183, 0x14},
...
//VGA Video Format:  640 * 480 at 30 FPS
static regval_list_t sensor_VGA_regs[] = {
// YUV VGA 30fps
// Input Clock = 24Mhz
    ...
    { 0x3c07, 0x08 }, // light meter 1 threshold [7:0]
    { 0x3820, 0x47 }, // Sensor flip on, ISP flip on : DA APPLICARE SU TUTTE!
    { 0x3821, 0x05 }, // Sensor mirror on, ISP mirror on, H binning on
    { 0x3814, 0x31 }, // X INC
    { 0x3815, 0x31 }, // Y INC
    { 0x3800, 0x00 }, // HS
    { 0x3801, 0x00 }, // HS
...
//HD720 Video Format:  1280 * 720 at 30 FPS
static regval_list_t sensor_720p_regs[] = {
// YUV, 1280x720, 30fps
// input clock 24Mhz
...
static regval_list_t sensor_5M_regs[] = {
...
//HD 1080p Video Format:  1920 * 1080 at 10 FPS
static regval_list_t sensor_1080p_regs[] = {
//YUV, 1080p, 10fps
    ...
    { 0x3108, 0x01 },
    { 0x3820, 0x47 }, // Sensor flip on, ISP flip on
    { 0x3821, 0x05 }, // Sensor mirror on, ISP mirror on, H binning on
    { 0x3824, 0x01 },
    ...
    { 0x3814, 0x11 }, //horizontal subsample
    ...
    { 0x3810, 0x00 }, //isp horizontal offset high byte
    { 0x3811, 0x10 }, //isp horizontal offset low byte
...
// BRIGHTNESS CONTROL
static struct regval_list cam_brightness_lvn4[] = {
    /* Level -4 */
    {
        0x5587, 0x40
    },             //* Y bright for contrast
    {
        0x5580, 0x04
    },             //* Contrast Enable
    {
        0x5588, 0x09
    },             //* Y bright sign for contrast
} ;

static struct regval_list cam_brightness_lvn3[] = {
    /* Level -3 */
    {
        0x5587, 0x30
    },             //* Y bright for contrast
...
static struct regval_list cam_brightness_lvn2[] = {
    /* Level -2 */
    {
        0x5587, 0x20
    },             //* Y bright for contrast
...
static struct regval_list cam_brightness_lvn1[] = {
    /* Level -1 */
    {
        0x5587, 0x10
    },             //* Y bright for contrast
...
static struct regval_list cam_brightness_lv0[] = {
    /* Level 0 */
    {
        0x5587, 0x00
    },             //* Y bright for contrast
...
static struct regval_list cam_brightness_lvp1[] = {
    /* Level +1 */
    {
        0x5587, 0x10
    },             //* Y bright for contrast
...
static struct regval_list cam_brightness_lvp2[] = {
    /* Level +2 */
    {
        0x5587, 0x20
    },             //* Y bright for contrast
...
static struct regval_list cam_brightness_lvp3[] = {
    /* Level +3 */
    {
        0x5587, 0x30
    },             //* Y bright for contrast
...
static struct regval_list cam_brightness_lvp4[] = {
    /* Level +4 */
    {
        0x5587, 0x40
    },             //* Y bright for contrast
...
// OV5640 AUTO FOCUS FIRMWARE
static regval_list_t AF_firmware[] = {
    { 0x3000, 0x20 },
    { 0x8000, 0x02 },
    { 0x8001, 0x0f },
    { 0x8002, 0xd6 },
