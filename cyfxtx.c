/*
 ...
 File Description:
 This file is taken from the FX3 SDK package. Please use the cyfxtx.c file from the latest FX3 SDK release as the base
 version of the file.
 This file defines the porting requied for the ThreadX RTOS. This file shall be provided in source form and must be compiled
 ...
 */
#define CY_U3P_MEM_HEAP_BASE         ((uint8_t *) 0x40038000) //0x4002A800)
#define CY_U3P_MEM_HEAP_SIZE         (0x8000) //5800)
